...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x84EEA114, 0xC6BE, 0x4445, {0x8F, 0x90, 0x51, 0xD9, 0x78, 0x63, 0xE3, 0x63}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuHotplugSmm";
...
const UINT32 _gDxeRevision = 0x00010046U;
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (CpuHotplugEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
